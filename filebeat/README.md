...
| `daemonset.args`               | Configurable [arguments][] to pass to the filebeat container for DaemonSet                                                                                                   | `["-e","-E","http.enabled=true"]`  |
...
| `deployment.args`              | Configurable [arguments][] to pass to the filebeat container for Deployment                                                                                                  | `["-e","-E","http.enabled=true"]`  |
...
| `varLibContainerPath`          | Path for both host and mount to directory with Kubernetes container logs, to use chart for both Linux and Windows nodes                                                      | `/var/lib/docker/containers`       |
| `varRunDockerSock`             | Path for both host and mount to Docker socket, to use chart for both Linux and Windows nodes                                                                                 | `/var/run/docker.sock`             |
