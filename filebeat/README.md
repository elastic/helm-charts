...
| `daemonset.extraArgs`          | Configurable additional [arguments][] to pass to the filebeat container for DaemonSet                                                                                        | `[]`                               |
...
| `deployment.extraArgs`         | Configurable additional [arguments][] to pass to the filebeat container for Deployment                                                                                       | `[]`                               |
