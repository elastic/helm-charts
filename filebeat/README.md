...
| `deployment.filebeatModules`   | Allows you to add any module configuration in `/usr/share/filebeat/modules.d/` such as `system.yml` for filebeat system module                                               | see [values.yaml][]                |
