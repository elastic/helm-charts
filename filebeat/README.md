...
* Install it:
  - with Helm 3: `helm install filebeat ./helm-charts/filebeat --set imageTag=7.13.2-SNAPSHOT`
  - with Helm 2 (deprecated): `helm install --name filebeat ./helm-charts/filebeat --set imageTag=7.13.2-SNAPSHOT`
...
| `imageTag`                     | The filebeat Docker image tag                                                                                                                                                | `7.13.2-SNAPSHOT`                  |
