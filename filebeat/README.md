...
* Install it:
  - with Helm 2: `helm install --name filebeat --version 7.9.3-SNAPSHOT elastic/filebeat`
  - with [Helm 3 (beta)][]: `helm install filebeat --version 7.9.3-SNAPSHOT elastic/filebeat`
