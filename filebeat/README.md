...
* Install it:
  - with Helm 2: `helm install --name filebeat --version 6.8.13 ./helm-charts/filebeat`
  - with [Helm 3 (beta)][]: `helm install filebeat --version 6.8.13 ./helm-charts/filebeat`
...
| `imageTag`               | The Filebeat Docker image tag                                                                                                                                                   | `6.8.13`                            |
...
[6.8.13]: https://github.com/elastic/helm-charts/blob/6.8.13/filebeat/README.md
