...
* Install it:
  - with Helm 2: `helm install --name filebeat --version 6.8.14-SNAPSHOT ./helm-charts/filebeat`
  - with [Helm 3 (beta)][]: `helm install filebeat --version 6.8.14-SNAPSHOT ./helm-charts/filebeat`
