...
| `monitor`                | Creates a prometheus-operator ServiceMonitor in order to allow prometheus to scrape metrics.  Requires an additional `extraContainers` entry.  See [values.yaml] for detail     | `false`                            |
