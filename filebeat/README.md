...
* Install it:
  - with Helm 3: `helm install filebeat ./helm-charts/filebeat --set imageTag=6.8.17`
  - with Helm 2 (deprecated): `helm install --name filebeat ./helm-charts/filebeat --set imageTag=6.8.17`
...
| `imageTag`                     | The filebeat Docker image tag                                                                                                                                                | `6.8.17-SNAPSHOT`                   |
...
[6.8.17]: https://github.com/elastic/helm-charts/blob/6.8.17/filebeat/README.md
