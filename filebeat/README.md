...
* Install it:
  - with Helm 3: `helm install filebeat ./helm-charts/filebeat --set imageTag=6.8.17-SNAPSHOT`
  - with Helm 2 (deprecated): `helm install --name filebeat ./helm-charts/filebeat --set imageTag=6.8.17-SNAPSHOT`
...
| `imageTag`                     | The filebeat Docker image tag                                                                                                                                                | `6.8.17-SNAPSHOT-SNAPSHOT`                   |
...
[6.8.17-SNAPSHOT]: https://github.com/elastic/helm-charts/blob/6.8.17-SNAPSHOT/filebeat/README.md
