...
* Install it:
  - with Helm 2: `helm install --name filebeat --version 7.9.1 elastic/filebeat`
  - with [Helm 3 (beta)][]: `helm install filebeat --version 7.9.1 elastic/filebeat`
...
| `imageTag`               | The Filebeat Docker image tag                                                                                                                                                   | `7.9.1`                   |
