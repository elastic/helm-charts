...
| `deployment.persistence`             | Enables a persistent volume for Filebeat data                                                                                                                                                                                        | see [values.yaml][] |
| `deployment.volumeClaimTemplate`     | Configuration for the [volumeClaimTemplate for Deployment][]. You will want to adjust the storage (default `1Gi` ) and the `storageClassName` if you are using a different storage class                                          | see [values.yaml][]                   |
