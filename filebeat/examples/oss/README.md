...
This example deploy Filebeat 7.12.2-SNAPSHOT using [Filebeat OSS][] version.
...
[goss integration tests]: https://github.com/elastic/helm-charts/tree/7.12/filebeat/examples/oss/test/goss.yaml
