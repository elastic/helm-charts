...
This example deploy Filebeat 7.9.4-SNAPSHOT using [Filebeat OSS][] version.
...
[goss integration tests]: https://github.com/elastic/helm-charts/tree/7.9/filebeat/examples/oss/test/goss.yaml
