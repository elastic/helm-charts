...
This example deploy Filebeat 7.14.1-SNAPSHOT using [Filebeat OSS][] version.
...
[goss integration tests]: https://github.com/elastic/helm-charts/tree/7.14/filebeat/examples/oss/test/goss.yaml
