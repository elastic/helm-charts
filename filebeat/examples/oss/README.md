...
This example deploy Filebeat 6.8.23-SNAPSHOT using [Filebeat OSS][] version.
...
[goss integration tests]: https://github.com/elastic/helm-charts/tree/6.8/filebeat/examples/oss/test/goss.yaml
