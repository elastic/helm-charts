...
* Install it:
  - with Helm 3: `helm install metricbeat ./helm-charts/metricbeat --set imageTag=6.8.16-SNAPSHOT`
  - with Helm 2 (deprecated): `helm install --name metricbeat ./helm-charts/metricbeat --set imageTag=6.8.16-SNAPSHOT`
...
| `imageTag`                     | The Metricbeat Docker image tag                                                                                                                                              | `6.8.16-SNAPSHOT`                    |
...
[6.8.16-SNAPSHOT]: https://github.com/elastic/helm-charts/blob/6.8.16-SNAPSHOT/metricbeat/README.md
...
[examples]: https://github.com/elastic/helm-charts/tree/6.8/metricbeat/examples
...
[kube-state-metrics]: https://github.com/helm/charts/tree/6.8/stable/kube-state-metrics
...
[values.yaml]: https://github.com/elastic/helm-charts/tree/6.8/metricbeat/values.yaml
