...
* Install it:
  - with Helm 3: `helm install metricbeat ./helm-charts/metricbeat --set imageTag=6.8.99`
  - with Helm 2 (deprecated): `helm install --name metricbeat ./helm-charts/metricbeat --set imageTag=6.8.99`
...
| `imageTag`                     | The Metricbeat Docker image tag                                                                                                                                              | `6.8.99`                    |
...
[6.8.99]: https://github.com/elastic/helm-charts/blob/6.8.99/metricbeat/README.md
