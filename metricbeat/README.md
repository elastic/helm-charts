...
* Install it:
  - with Helm 3: `helm install metricbeat ./helm-charts/metricbeat --set imageTag=6.8.18`
  - with Helm 2 (deprecated): `helm install --name metricbeat ./helm-charts/metricbeat --set imageTag=6.8.18`
...
| `imageTag`                     | The Metricbeat Docker image tag                                                                                                                                              | `6.8.18`                    |
...
[6.8.18]: https://github.com/elastic/helm-charts/blob/6.8.18/metricbeat/README.md
