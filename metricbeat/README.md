...
* Install it:
  - with Helm 2: `helm install --name metricbeat --version 6.8.13 ./helm-charts/metricbeat`
  - with [Helm 3 (beta)][]: `helm install metricbeat --version 6.8.13 ./helm-charts/metricbeat`
...
| `imageTag`                     | The Metricbeat Docker image tag                                                                                                                                              | `6.8.13`                    |
...
[6.8.13]: https://github.com/elastic/helm-charts/blob/6.8.13/metricbeat/README.md
