...
* Install it:
  - with Helm 3: `helm install metricbeat ./helm-charts/metricbeat --set imageTag=6.8.16`
  - with Helm 2 (deprecated): `helm install --name metricbeat ./helm-charts/metricbeat --set imageTag=6.8.16`
...
| `imageTag`                     | The Metricbeat Docker image tag                                                                                                                                              | `6.8.16`                    |
...
[6.8.16]: https://github.com/elastic/helm-charts/blob/6.8.16/metricbeat/README.md
