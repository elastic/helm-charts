...
* Install it:
  - with Helm 2: `helm install --name metricbeat --version 7.9.4-SNAPSHOT ./helm-charts/metricbeat`
  - with [Helm 3 (beta)][]: `helm install metricbeat --version 7.9.4-SNAPSHOT ./helm-charts/metricbeat`
...
| `imageTag`                     | The Metricbeat Docker image tag                                                                                                                                              | `7.9.4-SNAPSHOT`                     |
