...
* Install it:
  - with Helm 2: `helm install --name metricbeat ./helm-charts/metricbeat --set imageTag=7.9.1-SNAPSHOT`
  - with [Helm 3 (beta)][]: `helm install metricbeat ./helm-charts/metricbeat --set imageTag=7.9.1-SNAPSHOT`
...
| `imageTag`                     | The Metricbeat Docker image tag                                                                                                                                              | `7.9.1-SNAPSHOT`                     |
