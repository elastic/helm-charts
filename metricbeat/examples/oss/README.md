...
This example deploy Metricbeat 8.5.1 using [Metricbeat OSS][] version.
...
[goss integration tests]: https://github.com/elastic/helm-charts/tree/main/metricbeat/examples/oss/test/goss.yaml
