...
This example deploy Metricbeat 7.8.0-SNAPSHOT using [Metricbeat OSS][] version.
...
[goss integration tests]: https://github.com/elastic/helm-charts/tree/7.8/metricbeat/examples/oss/test/goss.yaml
