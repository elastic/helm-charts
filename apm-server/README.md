...
* Install it:
  - with Helm 3: `helm install apm-server ./helm-charts/apm-server --set imageTag=6.8.16`
  - with Helm 2 (deprecated): `helm install --name apm-server ./helm-charts/apm-server --set imageTag=6.8.16`
...
| `imageTag`                  | The APM Server Docker image tag                                                                                                                            | `6.8.16`                  |
...
[6.8.16]: https://github.com/elastic/helm-charts/blob/6.8.16/apm-server/README.md
