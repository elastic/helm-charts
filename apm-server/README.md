...
* Install it:
  - with Helm 3: `helm install apm-server ./helm-charts/apm-server --set imageTag=6.8.99`
  - with Helm 2 (deprecated): `helm install --name apm-server ./helm-charts/apm-server --set imageTag=6.8.99`
...
| `imageTag`                  | The APM Server Docker image tag                                                                                                                            | `6.8.99`                  |
...
[6.8.99]: https://github.com/elastic/helm-charts/blob/6.8.99/apm-server/README.md
