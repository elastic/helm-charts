...
* Install it:
  - with Helm 3: `helm install apm-server ./helm-charts/apm-server --set imageTag=7.14.0`
  - with Helm 2 (deprecated): `helm install --name apm-server ./helm-charts/apm-server --set imageTag=7.14.0`
...
| `imageTag`                  | The APM Server Docker image tag                                                                                                                            | `7.14.0`                  |
...
[examples]: https://github.com/elastic/helm-charts/tree/7.14/apm-server/examples
[examples/oss]: https://github.com/elastic/helm-charts/tree/7.14/apm-server/examples/oss
[examples/security]: https://github.com/elastic/helm-charts/tree/7.14/apm-server/examples/security
[helm]: https://helm.sh
...
[values.yaml]: https://github.com/elastic/helm-charts/tree/7.14/apm-server/values.yaml
