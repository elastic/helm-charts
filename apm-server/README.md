...
| `podSecurityContext`     | Configurable [podSecurityContext][] for APM Server pod execution environment                                                                               | `runAsUser: 0` <br> `privileged: false`                                                                                           |
...
| `resources`              | Allows you to set the [resources][] for the `Deployment`                                                                                                   | `requests.cpu: 100m` <br> `requests.memory: 100Mi` <br> `limits.cpu: 1000m` <br> `limits.memory: 200Mi`                           |
...
| `service`                | Configurable [service][] to expose the APM Server service. See [values.yaml][] for an example                                                              | `type: ClusterIP` <br> `port: 8200` <br> `nodePort:` <br> `annotations: {}`                                                       |
...
| `updateStrategy`         | Allows you to change the default [updateStrategy][] for the deployment                                                                                     | `RollingUpdate`                                                                                                                   |
