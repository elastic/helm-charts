...
* Install it:
  - with Helm 3: `helm install apm-server ./helm-charts/apm-server --set imageTag=6.8.19-SNAPSHOT`
  - with Helm 2 (deprecated): `helm install --name apm-server ./helm-charts/apm-server --set imageTag=6.8.19-SNAPSHOT`
...
| `imageTag`                  | The APM Server Docker image tag                                                                                                                            | `6.8.19-SNAPSHOT`                  |
...
[6.8.19-SNAPSHOT]: https://github.com/elastic/helm-charts/blob/6.8.19-SNAPSHOT/apm-server/README.md
