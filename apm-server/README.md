...
* Install it:
  - with Helm 2: `helm install --name apm-server ./helm-charts/apm-server --set imageTag=7.9.0-SNAPSHOT`
  - with [Helm 3 (beta)][]: `helm install apm-server ./helm-charts/apm-server --set imageTag=7.9.0-SNAPSHOT`
