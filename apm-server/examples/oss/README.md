...
This example deploy APM Server 7.9.4-SNAPSHOT using [APM Server OSS][] version.
...
[goss integration tests]: https://github.com/elastic/helm-charts/tree/7.9/apm-server/examples/oss/test/goss.yaml
