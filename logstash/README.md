...
* Install it:
  - with Helm 2: `helm install --name logstash ./helm-charts/logstash --set imageTag=7.9.1-SNAPSHOT`
  - with [Helm 3 (beta)][]: `helm install logstash ./helm-charts/logstash --set imageTag=7.9.1-SNAPSHOT`
...
| `imageTag`                | The Logstash Docker image tag                                                                                                                                                                                                        | `7.9.1-SNAPSHOT`                      |
