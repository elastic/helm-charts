...
* Install it:
  - with Helm 3: `helm install logstash ./helm-charts/logstash --set imageTag=6.8.16`
  - with Helm 2 (deprecated): `helm install --name logstash ./helm-charts/logstash --set imageTag=6.8.16`
...
| `imageTag`                | The Logstash Docker image tag                                                                                                                                                                                                        | `6.8.16`                     |
...
[6.8.16]: https://github.com/elastic/helm-charts/blob/6.8.16/logstash/README.md
