...
* Install it:
  - with Helm 3: `helm install logstash ./helm-charts/logstash --set imageTag=6.8.99`
  - with Helm 2 (deprecated): `helm install --name logstash ./helm-charts/logstash --set imageTag=6.8.99`
...
| `imageTag`                | The Logstash Docker image tag                                                                                                                                                                                                        | `6.8.99`                     |
...
[6.8.99]: https://github.com/elastic/helm-charts/blob/6.8.99/logstash/README.md
