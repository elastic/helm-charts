...
* Install it:
  - with Helm 3: `helm install logstash ./helm-charts/logstash --set imageTag=6.8.19-SNAPSHOT`
  - with Helm 2 (deprecated): `helm install --name logstash ./helm-charts/logstash --set imageTag=6.8.19-SNAPSHOT`
...
| `imageTag`                | The Logstash Docker image tag                                                                                                                                                                                                        | `6.8.19-SNAPSHOT`                     |
...
[6.8.19-SNAPSHOT]: https://github.com/elastic/helm-charts/blob/6.8.19-SNAPSHOT/logstash/README.md
