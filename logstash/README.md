...
* Install it:
  - with Helm 2: `helm install --name logstash --version 7.9.1 elastic/logstash`
  - with [Helm 3 (beta)][]: `helm install logstash --version 7.9.1 elastic/logstash`
...
| `imageTag`                | The Logstash Docker image tag                                                                                                                                                                                                        | `7.9.1`                      |
