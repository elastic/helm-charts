...
* Install it:
  - with Helm 2: `helm install --name logstash ./helm-charts/logstash --set imageTag=7.9.0-SNAPSHOT`
  - with [Helm 3 (beta)][]: `helm install logstash ./helm-charts/logstash --set imageTag=7.9.0-SNAPSHOT`
