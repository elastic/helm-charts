...
| `existingPipelineConfigmap` | Allows you to specify an existing configmap containing pipeline files to add to `/usr/share/logstash/pipeline/`. If set `logstashPipeline` is ignored.                                                                               | `""`                                  |
