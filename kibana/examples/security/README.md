...
This example deploy Kibana 7.10.0-SNAPSHOT using authentication and TLS to connect to
...
[values]: https://github.com/elastic/helm-charts/tree/7.10/kibana/examples/security/security.yml
