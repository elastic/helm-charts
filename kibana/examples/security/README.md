...
This example deploy Kibana 7.8.1-SNAPSHOT using authentication and TLS to connect to
...
[values]: https://github.com/elastic/helm-charts/tree/7.8/kibana/examples/security/security.yml
