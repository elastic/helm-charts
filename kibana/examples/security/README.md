...
This example deploy Kibana 6.8.10-SNAPSHOT using authentication and TLS to connect to
...
[values]: https://github.com/elastic/helm-charts/tree/6.8/kibana/examples/security/security.yaml
