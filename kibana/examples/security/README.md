...
This example deploy Kibana 7.8.0-SNAPSHOT using authentication and TLS to connect to
...
[values]: https://github.com/elastic/helm-charts/tree/7.x/kibana/examples/security/security.yaml
