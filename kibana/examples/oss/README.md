...
This example deploy Kibana 7.11.0-SNAPSHOT using [Kibana OSS][] version.
...
[goss integration tests]: https://github.com/elastic/helm-charts/tree/7.11/kibana/examples/oss/test/goss.yaml
