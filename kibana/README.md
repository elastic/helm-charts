...
* Install it: `helm install kibana ./helm-charts/kibana --set imageTag=8.4.1`
...
| `imageTag`                                | The Kibana Docker image tag                                                                                                                                                                                                                          | `8.4.1`                             |
...
| `rbac`                                    | Configuration for creating a ServiceAccount as part of this Helm chart with `create: true`. Also can be used to reference an external ServiceAccount with `serviceAccountName: "externalServiceAccountName"`, or automount the service account token | see [values.yaml][]                 |
