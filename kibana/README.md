...
| `healthCheckHttpCode`         | The http_code is used for the readinessProbe to check that Kibana is ready. If you are installing some SSO plugins then you might need to set to this value to `301`                                                                                                                                                                                        | `200`                                                                                                             |
