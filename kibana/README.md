...
* Install it:
  - with Helm 2: `helm install --name kibana --version 6.8.13 ./helm-charts/kibana`
  - with [Helm 3 (beta)][]: `helm install kibana --version 6.8.13 ./helm-charts/kibana`
...
| `imageTag`            | The Kibana Docker image tag                                                                                                                                                                    | `6.8.13`                  |
...
[6.8.13]: https://github.com/elastic/helm-charts/blob/6.8.13/kibana/README.md
