...
* Install it:
  - with Helm 3: `helm install kibana ./helm-charts/kibana --set imageTag=7.11.0`
  - with Helm 2 (deprecated): `helm install --name kibana ./helm-charts/kibana --set imageTag=7.11.0`
...
| `imageTag`            | The Kibana Docker image tag                                                                                                                                                                    | `7.11.0`                  |
...
[examples/oss]: https://github.com/elastic/helm-charts/tree/7.11/kibana/examples/oss
