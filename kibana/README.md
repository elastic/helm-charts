...
While only the latest releases are tested, it is possible to easily install old or new releases by overriding the `imageTag`. To install version `7.6.0` of Kibana it would look like this:

```
helm install --name kibana elastic/kibana --set imageTag=7.6.0
```
...
| `imageTag`                | The Kibana docker image tag                                                                                                                                                                                                                                                                                                                                    | `7.6.0`                                                                                                                   |
...
| `ingressRoute`                 | Configurable traefik [ingressRoute](https://docs.traefik.io/routing/providers/kubernetes-crd/#kind-ingressroute) to expose the Kibana service. See [`values.yaml`](https://github.com/elastic/helm-charts/tree/master/kibana/values.yaml) for an example.                                                                                                                              | `enabled: false`                                                                                                          |
