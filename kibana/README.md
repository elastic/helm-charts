...
- [Installing](#installing)
  ...
  - [Install development version using 6.8 branch and 6.8.18 versions](#install-development-version-using-68-branch-and-6813-snapshot-versions)
- [Upgrading](#upgrading)
...
This chart is tested with the latest 6.8.18 version.
...
### Install development version using 6.8 branch and 6.8.18 versions
...
* Install it:
  - with Helm 3: `helm install kibana ./helm-charts/kibana --set imageTag=6.8.18`
  - with Helm 2 (deprecated): `helm install --name kibana ./helm-charts/kibana --set imageTag=6.8.18`
...
| `imageTag`            | The Kibana Docker image tag                                                                                                                                                                    | `6.8.18`                  |
...
[6.8.18]: https://github.com/elastic/helm-charts/blob/6.8.18/kibana/README.md
