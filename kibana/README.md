...
* Install it:
  - with Helm 2: `helm install --name kibana ./helm-charts/kibana --set imageTag=7.9.0-SNAPSHOT`
  - with [Helm 3 (beta)][]: `helm install kibana ./helm-charts/kibana --set imageTag=7.9.0-SNAPSHOT`
...
| `imageTag`            | The Kibana Docker image tag                                                                                                                                                                    | `7.9.0-SNAPSHOT`                   |
...
[7.8.1]: https://github.com/elastic/helm-charts/blob/7.8.1/kibana/README.md
