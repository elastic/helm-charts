...
`helm install --name kibana elastic/kibana --version=6.8.9`
...
| `imageTag`            | The Kibana Docker image tag                                                                                                                                                                    | `6.8.9-SNAPSHOT`                            |
...
[kibana oss docker image]: https://www.docker.elastic.co/#kibana-6-8-9-oss
