...
* Install it:
  - with Helm 3: `helm install kibana ./helm-charts/kibana --set imageTag=6.8.16`
  - with Helm 2 (deprecated): `helm install --name kibana ./helm-charts/kibana --set imageTag=6.8.16`
...
| `imageTag`            | The Kibana Docker image tag                                                                                                                                                                    | `6.8.16`                  |
...
[6.8.16]: https://github.com/elastic/helm-charts/blob/6.8.16/kibana/README.md
