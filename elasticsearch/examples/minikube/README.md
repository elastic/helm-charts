...
This example deploy a 3 nodes Elasticsearch 7.12.1-SNAPSHOT cluster on [Minikube][]
using [custom values][].
...
[custom values]: https://github.com/elastic/helm-charts/tree/7.12/elasticsearch/examples/minikube/values.yaml
