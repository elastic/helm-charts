...
This example deploy a 3 nodes Elasticsearch 6.8.23-SNAPSHOT cluster on [Minikube][]
using [custom values][].
...
[custom values]: https://github.com/elastic/helm-charts/tree/6.8/elasticsearch/examples/minikube/values.yaml
