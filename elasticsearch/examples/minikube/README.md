...
This example deploy a 3 nodes Elasticsearch 7.11.3-SNAPSHOT cluster on [Minikube][]
using [custom values][].
...
[custom values]: https://github.com/elastic/helm-charts/tree/7.11/elasticsearch/examples/minikube/values.yaml
