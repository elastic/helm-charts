...
This example deploy a 3 nodes Elasticsearch 7.14.1-SNAPSHOT cluster on [Kind][]
using [custom values][].
...
[custom values]: https://github.com/elastic/helm-charts/blob/7.14/elasticsearch/examples/kubernetes-kind/values.yaml
...
[Makefile]: https://github.com/elastic/helm-charts/blob/7.14/elasticsearch/examples/kubernetes-kind/Makefile#L5
