...
* Install it:
  - with Helm 2: `helm install --name elasticsearch --version 7.9.3 elastic/elasticsearch`
  - with [Helm 3 (beta)][]: `helm install elasticsearch --version 7.9.3 elastic/elasticsearch`
