...
| `antiAffinity`                     | Setting this to hard enforces the [anti-affinity][] rules. If it is set to soft it will be done "best effort". Other values will be ignored - if you need more fine-grained control, use customAntiAffinity                                                                                                       | `hard`                                           |
...
| `customAntiAffinity`               | Allows you to define custom pod [anti-affinity][] settings in case the default antiAffinity settings are not suitable for your setup.                                                                                                                                                                             | `{}`                                             |
