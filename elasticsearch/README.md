...
* Install it: `helm install --name elasticsearch ./helm-charts/elasticsearch  --set imageTag=7.7.0`
...
```
helm install --name elasticsearch elastic/elasticsearch --set imageTag=7.7.0
```
