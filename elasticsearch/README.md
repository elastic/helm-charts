...
* Install it:
  - with Helm 3: `helm install elasticsearch ./helm-charts/elasticsearch --set imageTag=6.8.17-SNAPSHOT`
  - with Helm 2 (deprecated): `helm install --name elasticsearch ./helm-charts/elasticsearch --set imageTag=6.8.17-SNAPSHOT`
...
| `imageTag`                         | The Elasticsearch Docker image tag                                                                                                                                                                                                                                                                                | `6.8.17-SNAPSHOT`                                 |
...
[6.8.17-SNAPSHOT]: https://github.com/elastic/helm-charts/blob/6.8.17-SNAPSHOT/elasticsearch/README.md
