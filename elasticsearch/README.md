...
* Install it:
  - with Helm 3: `helm install elasticsearch ./helm-charts/elasticsearch --set imageTag=6.8.21`
  - with Helm 2 (deprecated): `helm install --name elasticsearch ./helm-charts/elasticsearch --set imageTag=6.8.21`
...
[6.8.21]: https://github.com/elastic/helm-charts/blob/6.8.21/elasticsearch/README.md
