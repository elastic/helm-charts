...
| `roles`                            | A hash map with the specific [roles][] for the `nodeGroup`. Some roles may be skipped if they're unavailable in the major version indicated by esMajorVersion.                                                                                            | see [values.yaml][]                             |
