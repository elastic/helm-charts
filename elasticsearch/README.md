...
* Install it:
  - with Helm 3: `helm install elasticsearch ./helm-charts/elasticsearch --set imageTag=6.8.15`
  - with Helm 2 (deprecated): `helm install --name elasticsearch ./helm-charts/elasticsearch --set imageTag=6.8.15`
...
| `imageTag`                         | The Elasticsearch Docker image tag                                                                                                                                                                                                                        | `6.8.15`                               |
...
| `service.sessionAffinity`          | Set the session affinity.  Useful in SSL handshake scenarios, for example to set "ClientIP" here.  Leaving unset will default to whatever your cluster defaults to (varies by provider and implementation).                                               | `""`
...
[6.8.15]: https://github.com/elastic/helm-charts/blob/6.8.15/elasticsearch/README.md
