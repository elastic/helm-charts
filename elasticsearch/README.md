...
| `readinessProbe`              | Configuration fields for the [readinessProbe](https://kubernetes.io/docs/tasks/configure-pod-container/configure-liveness-readiness-probes/) and optional custom readinessprobe                                                                                                                                             | `failureThreshold: 3`<br>`initialDelaySeconds: 10`<br>`periodSeconds: 10`<br>`successThreshold: 3`<br>`timeoutSeconds: 5` |
| `readinessProbe.custom`       | Configuration fields for a custom readinessProbe to use instead of the default one                                                                                                                                                                                                                                          | `{}`                                                                                                                      |
