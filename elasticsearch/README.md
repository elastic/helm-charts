...
* Install it:
  - with Helm 3: `helm install elasticsearch ./helm-charts/elasticsearch --set imageTag=7.11.0`
  - with Helm 2 (deprecated): `helm install --name elasticsearch ./helm-charts/elasticsearch --set imageTag=7.11.0`
...
| `imageTag`                         | The Elasticsearch Docker image tag                                                                                                                                                                                                                        | `7.11.0`                               |
...
[examples/oss]: https://github.com/elastic/helm-charts/tree/7.11/elasticsearch/examples/oss
