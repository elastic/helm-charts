...
| `masterService`            | The service name used for [discovery.zen.ping.unicast.hosts](https://www.elastic.co/guide/en/elasticsearch/reference/current/modules-discovery-zen.html#unicast) to connect to the masters                                                                                                                                 | `{{ .Values.clusterName }}-{{ .Values.nodeGroup }}`                                                                                                    |
