...
This chart is tested with the latest 7.13.3-SNAPSHOT version.
...
* Install it:
  - with Helm 3: `helm install elasticsearch ./helm-charts/elasticsearch --set imageTag=7.13.3-SNAPSHOT`
  - with Helm 2 (deprecated): `helm install --name elasticsearch ./helm-charts/elasticsearch --set imageTag=7.13.3-SNAPSHOT`
...
| `imageTag`                         | The Elasticsearch Docker image tag                                                                                                                                                                                                                                                                                | `7.13.3-SNAPSHOT`                                |
